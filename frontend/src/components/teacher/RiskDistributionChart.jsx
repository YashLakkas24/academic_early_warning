...
export default function RiskDistributionChart({ summary }) {
  ...
  return (
    <div className="panel">
      ...
      <p className="panel-subtitle">Current distribution of students by academic risk level.</p>
      ...
      <ResponsiveContainer width="100%" height={220}>
        ...
        >
          ...
          <Bar
            ...
            radius={[8, 8, 0, 0]}
            maxBarSize={64}
            onClick={(entry) => setActiveLevel(entry.level === activeLevel ? null : entry.level)}
      ...
      <div className="risk-callout">
        {active ? (
          <>
            <span className="dot" style={{ background: LEVEL_META[active.level].hex }} />
            Number of <strong>{LEVEL_META[active.level].label} Risk</strong> Students:{' '}
